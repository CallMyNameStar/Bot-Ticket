...
module.exports = class extends Command {
    ...
    .setColor('GREEN')
    .setTitle(`Hello, im ticketer and here are my commands!`)
    .setDescription("Make sure to use `>>[cmd_name]` for further assistance.")
    ...
    message.channel.send(embed)
        ...
        if(!cmd) return message.channel.send(`i cant find the command`);
